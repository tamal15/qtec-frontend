...
const TopSelling = () => {
  ...
  return (
    ...
    <div className="flex justify-between items-center mb-6 px-4  sm:px-6 md:px-5">
  {/* Left Text */}
  <h2 className="text-left text-lg sm:text-xl md:text-2xl font-bold leading-snug">
  ...
  <button className="bg-gradient-to-r from-[#8CD005] to-[#19745B] 
                     text-white font-semibold px-5 sm:px-6 md:px-8 py-2 sm:py-3 md:py-4 
