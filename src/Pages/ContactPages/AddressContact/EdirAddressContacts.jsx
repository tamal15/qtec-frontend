...
const EditAddressContacts = () => {
  ...
  // Fetch banner data
  useEffect(() => {
    fetch(`https://webi-bacend.onrender.com/editProjectHome/${id}`)
      .then((res) => res.json())
  ...
  const handleUpdate = async (e) => {
    ...
    fetch(`https://webi-bacend.onrender.com/projecthomeupdate/${id}`, {
      method: "PUT",
...
export default EditAddressContacts;
