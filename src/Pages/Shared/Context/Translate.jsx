...
const resources = {
    en: {
      translation: {
        ...
        sellSomething: "Got something to sell? Post your first ad and earn money and many product upload!",
        freeAd: "Post Free Ad",
        boostAd: "Boost Ad Products",
        boostDescription: "Boost your ad to show it to more people and sell faster many boost list so choice user!",
      ...
      carsGuide: "Cars Guide",
      bikesGuide: "Bikes Guide",
    ...
    bn: {
      translation: {
        ...
        sellSomething: "আপনার কাছে বিক্রি করার কিছু আছে? আপনার প্রথম বিজ্ঞাপনটি পোস্ট করুন এবং অর্থ আয় করুন!",
        freeAd: "ফ্রি বিজ্ঞাপন দিন",
        boostAd: "বিজ্ঞাপন বুস্ট করুন",
        boostDescription: "আপনার বিজ্ঞাপনটি আরও বেশি মানুষকে দেখানোর জন্য এটি বুস্ট করুন এবং দ্রুত বিক্রি করুন!",
        learnMore: "আরও জানুন →",
        logins: "লগ ইন",
