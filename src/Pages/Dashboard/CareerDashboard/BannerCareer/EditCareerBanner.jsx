...
const EditCareerBanner = () => {
  ...
  // Fetch banner data
  useEffect(() => {
    fetch(`https://webi-bacend.onrender.com/editcareerbanner/${id}`)
      .then((res) => res.json())
  ...
  const handleUpdate = async (e) => {
    ...
    fetch(`https://webi-bacend.onrender.com/careerbannerupdate/${id}`, {
      method: "PUT",
...
export default EditCareerBanner;
