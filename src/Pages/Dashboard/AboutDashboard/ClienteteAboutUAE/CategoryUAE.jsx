...
import AddCategoryUAE from "./AddCategoryUAE";
  ...
  const handleDelete = (id) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        axios
          .delete(`https://webi-bacend.onrender.com/clientcategoryuaedelete/${id}`)
          .then((response) => {
            response.status === 204 &&
      ...
      <div className="w-[32%] flex items-center justify-center -ms-6">
        ...
        />
                    ...
                    <div className="w-[32%] flex items-center justify-center">
                      <NavLink
                        to={`/dashboard/editscategoryUAE/${d._id}`}
                        style={{
                          textDecoration: "none",
                          marginRight: "-10px",
                        }}
