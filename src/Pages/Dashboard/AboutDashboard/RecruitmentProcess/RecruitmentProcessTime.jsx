...
import AddRecruitmentProcess from "./AddRecruitmentProcess";
import axios from "axios";
import Swal from "sweetalert2";
import { MdOutlineDeleteOutline } from "react-icons/md";


const RecruitmentProcessTime = () => {
                ...
                {data?.map((d, i) => (
                  ...
                  >
                    ...
                    <div className="w-[32%] flex items-center justify-center">
                      <NavLink
                        to={`/dashboard/editrecruitmentprocess/${d._id}`}
                        style={{
                          textDecoration: "none",
                          marginRight: "-10px",
                        }}
...
export default RecruitmentProcessTime;
