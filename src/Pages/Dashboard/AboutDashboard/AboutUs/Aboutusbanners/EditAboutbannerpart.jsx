...
const EditAboutbannerpart = () => {
  ...
  // Fetch banner data
  useEffect(() => {
    fetch(`https://webi-bacend.onrender.com/editsbannersabouts/${id}`)
      .then((res) => res.json())
  ...
  const handleUpdate = async (e) => {
    ...
    fetch(`https://webi-bacend.onrender.com/aboutusbannersupdate/${id}`, {
      method: "PUT",
...
export default EditAboutbannerpart;
