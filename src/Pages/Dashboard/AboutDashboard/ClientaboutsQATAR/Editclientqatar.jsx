...
const Editclientqatar = () => {
  ...
  // Fetch banner data
  useEffect(() => {
    fetch(`https://webi-bacend.onrender.com/editclienteteaboutsqatar/${id}`)
      .then((res) => res.json())
  ...
  const handleUpdate = async (e) => {
    ...
    fetch(`https://webi-bacend.onrender.com/clientsqatarsdates/${id}`, {
      method: "PUT",
...
export default Editclientqatar;
