...
const AddCategoryskuwaits = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      await axios.post("https://webi-bacend.onrender.com/postscategoryskuwaits", formData); // Adjust the URL to your backend API
      Swal.fire({
        icon: "success",
        title: "Success",
            ...
            <div className="py-5 px-8">
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                <input
                  ...
                  placeholder="category only ex:All"
                />
...
export default AddCategoryskuwaits;
