...
const EditClientetebanners = () => {
  ...
  // Fetch banner data
  useEffect(() => {
    fetch(`https://webi-bacend.onrender.com/editsclientetebanners/${id}`)
      .then((res) => res.json())
  ...
  const handleUpdate = async (e) => {
    ...
    fetch(`https://webi-bacend.onrender.com/clientetesbannersupdate/${id}`, {
      method: "PUT",
...
export default EditClientetebanners;
