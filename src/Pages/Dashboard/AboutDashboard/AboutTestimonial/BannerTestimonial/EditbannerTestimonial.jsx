...
const EditBannerTestimonial = () => {
  ...
  // Fetch banner data
  useEffect(() => {
    fetch(`https://webi-bacend.onrender.com/edittestimonailbanner/${id}`)
      .then((res) => res.json())
  ...
  const handleUpdate = async (e) => {
    ...
    fetch(`https://webi-bacend.onrender.com/banertestimonialupdate/${id}`, {
      method: "PUT",
...
export default EditBannerTestimonial;
