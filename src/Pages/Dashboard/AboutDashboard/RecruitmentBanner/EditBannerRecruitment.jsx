...
const EditBannerRecruitment = () => {
  ...
  // Fetch banner data
  useEffect(() => {
    fetch(`https://webi-bacend.onrender.com/editrecruitmentbanner/${id}`)
      .then((res) => res.json())
  ...
  const handleUpdate = async (e) => {
    ...
    fetch(`https://webi-bacend.onrender.com/recruitmentbannerupdate/${id}`, {
      method: "PUT",
...
export default EditBannerRecruitment;
