...
const AddBlogpart = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      await axios.post("https://webi-bacend.onrender.com/postblogpart", formData); // Adjust the URL to your backend API
      Swal.fire({
        icon: "success",
        title: "Success",
            ...
            <div className="py-5 px-8">
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                ...
                <input
                  ...
                  className="input input-text border border-[#01c0c9] hover:border-[#007cde] rounded-3xl px-5 py-2 w-full text-xl"
                  placeholder="Date (e.g., November 12, 2024)"
                />
                <textarea
