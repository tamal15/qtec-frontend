...
const EditCareEventBanner = () => {
  ...
  // Fetch banner data
  useEffect(() => {
    fetch(`https://webi-bacend.onrender.com/editeventcarebanner/${id}`)
      .then((res) => res.json())
  ...
  const handleUpdate = async (e) => {
    ...
    fetch(`https://webi-bacend.onrender.com/eventwecareupdate/${id}`, {
      method: "PUT",
...
export default EditCareEventBanner;
