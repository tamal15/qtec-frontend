...
const EditTestimonialHome = () => {
  ...
  // Fetch banner data
  useEffect(() => {
    fetch(`https://webi-bacend.onrender.com/editTestimonail/${id}`)
      .then((res) => res.json())
  ...
  const handleUpdate = async (e) => {
    ...
    fetch(`https://webi-bacend.onrender.com/testimonialupdate/${id}`, {
      method: "PUT",
...
export default EditTestimonialHome;
