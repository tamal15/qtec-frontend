            ...
            >
              ...
              <form onSubmit={handleUpdate}>
                ...
                <input
                  ...
                  className="input input-text border-[2px] border-[#01c0c9] hover:border-[#007cde] rounded-3xl px-5 py-2 w-full input-wrapper md:min-w-[450px] max-w-[20.5rem] mx-2 text-xl mt-2"
                  placeholder="numberYear"
                  name="numberYear"
                />
                <br />
                <input
                  onChange={handleChange}
                  value={banner?.yearTitle}
                  style={{
                    fontWeight: "600",
                    color: "#0E1621",
                    height: "50px",
                  ...
                  className="input input-text border-[2px] border-[#01c0c9] hover:border-[#007cde] rounded-3xl px-5 py-2 w-full input-wrapper md:min-w-[450px] max-w-[20.5rem] mx-2 text-xl mt-2"
                  placeholder="yearTitle"
                  name="yearTitle"
                />
                <br />
                <input
                  onChange={handleChange}
                  value={banner?.numberLocation}
                  style={{
                    fontWeight: "600",
                    color: "#0E1621",
                    height: "50px",
                  ...
                  className="input input-text border-[2px] border-[#01c0c9] hover:border-[#007cde] rounded-3xl px-5 py-2 w-full input-wrapper md:min-w-[450px] max-w-[20.5rem] mx-2 text-xl mt-2"
                  placeholder="numberLocation"
                  name="numberLocation"
                />
                <br />
                <input
                  onChange={handleChange}
                  value={banner?.locationTitle}
                  style={{
                    fontWeight: "600",
                    color: "#0E1621",
                    height: "50px",
                ...
                <input
                  ...
                  className="input input-text border-[2px] border-[#01c0c9] hover:border-[#007cde] rounded-3xl px-5 py-2 w-full input-wrapper md:min-w-[450px] max-w-[20.5rem] mx-2 text-xl mt-2"
                  placeholder="clientTitle"
                  name="clientTitle"
                />
                <br />
                <input
                  onChange={handleChange}
                  value={banner?.numberCandidate}
                  style={{
                    fontWeight: "600",
                    color: "#0E1621",
                    height: "50px",
                  ...
                  className="input input-text border-[2px] border-[#01c0c9] hover:border-[#007cde] rounded-3xl px-5 py-2 w-full input-wrapper md:min-w-[450px] max-w-[20.5rem] mx-2 text-xl mt-2"
                  placeholder="numberCandidate"
                  name="numberCandidate"
                />
                <br />
                <input
                  onChange={handleChange}
                  value={banner?.candidateTitle}
                  style={{
                    fontWeight: "600",
                    color: "#0E1621",
                    height: "50px",
...
export default EditHomeAboutus;
