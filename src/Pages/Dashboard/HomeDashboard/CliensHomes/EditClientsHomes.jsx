...
const EditclientsHomes = () => {
  ...
  // Fetch banner data
  useEffect(() => {
    fetch(`https://webi-bacend.onrender.com/editshomescleints/${id}`)
      .then((res) => res.json())
  ...
  const handleUpdate = async (e) => {
    ...
    fetch(`https://webi-bacend.onrender.com/clientshomessdates/${id}`, {
      method: "PUT",
...
export default EditclientsHomes;
