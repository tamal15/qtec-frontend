...
const EditCategoryclinthome = () => {
  ...
  // Fetch banner data
  useEffect(() => {
    fetch(`https://webi-bacend.onrender.com/editshomescategoryclients/${id}`)
      .then((res) => res.json())
  ...
  const handleUpdate = async (e) => {
    ...
    fetch(`https://webi-bacend.onrender.com/homecategoryclientsupdates/${id}`, {
      method: "PUT",
            ...
            >
              ...
              <form onSubmit={handleUpdate}>
                <input
                  ...
                  placeholder="category:construction/restaurant"
                  name="category"
                />
                <br />
...
export default EditCategoryclinthome;
