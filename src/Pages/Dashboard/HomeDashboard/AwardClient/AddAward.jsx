...
const AddAward = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      await axios.post("https://webi-bacend.onrender.com/postaward", formData);  // Adjust the URL to your backend API
      Swal.fire({
        icon: "success",
        title: "Post Success",
          ...
          <div className="relative p-4 w-full max-w-xl bg-white rounded-lg shadow-md">
            <div className="mt-4 mb-6">
              <div className="flex items-center justify-between p-4 border-b rounded-t dark:border-gray-600">
                <h2 className="text-xl font-semibold text-black">Add Your Award</h2>
                <button
                  onClick={toggleModal}
                  type="button"
