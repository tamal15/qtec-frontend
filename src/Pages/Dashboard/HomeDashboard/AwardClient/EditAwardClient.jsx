...
const EditAwardClient = () => {
  ...
  // Fetch banner data
  useEffect(() => {
    fetch(`https://webi-bacend.onrender.com/editawardckient/${id}`)
      .then((res) => res.json())
  ...
  const handleUpdate = async (e) => {
    ...
    fetch(`https://webi-bacend.onrender.com/awardclientupdate/${id}`, {
      method: "PUT",
...
export default EditAwardClient;
