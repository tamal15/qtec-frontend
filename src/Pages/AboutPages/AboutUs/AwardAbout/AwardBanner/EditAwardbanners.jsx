...
const EditAwardbanners = () => {
  ...
  // Fetch banner data
  useEffect(() => {
    fetch(`https://webi-bacend.onrender.com/editsawardbanners/${id}`)
      .then((res) => res.json())
  ...
  const handleUpdate = (e) => {
    ...
    fetch(`https://webi-bacend.onrender.com/awardaboutsbannersupdate/${id}`, {
      method: "PUT",
...
export default EditAwardbanners;
