...
const ClienteleBanner = () => {
  return (
    <div
      className="relative w-full h-[300px] md:h-[300px] lg:h-[340px] bg-cover bg-center bg-fixed flex items-center justify-center"
      style={{
    ...
    >
      ...
      <div className="relative z-10 text-white text-center px-4">
        <h1 className="text-3xl md:text-4xl lg:text-5xl font-semibold">CLIENTELE</h1>
      </div>
    </div>
  );
};
