...
const PostCareerdata = () => {
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        const response = await fetch(`https://webi-bacend.onrender.com/getcareerdata`);
              ...
              <div className="min-w-[400px] md:min-w-[650px]">
                ...
                {data?.map((d, i) => (
                  ...
                  >
                    ...
                    <p className="w-[32%] text-left ms-8">{d.mobile}</p>
                    <p className="w-[32%] text-left ms-8">
  <a
    href={d.link} // Make sure d.link contains the correct URL to the PDF file
    target="_blank" // Opens the link in a new tab
    rel="noopener noreferrer" // Prevents security risks with new tab navigation
