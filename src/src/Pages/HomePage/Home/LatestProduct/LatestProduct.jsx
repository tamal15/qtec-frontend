...
const LatestProduct = () => {
  ...
  const toggleSeeProducts = () => {
    if (expanded) {
      ...
      setVisibleCount(Math.min(visibleCount + 10, shuffledProducts.length));
    }
  ...
  return (
    <div className="bg-white py-6 px-6 md:px-20">
      ...
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-xl font-bold text-gray-800">Latest Product</h2>
      ...
      <div className="overflow-hidden w-full">
        <div className="grid grid-cols-2 mt-2 ms-2 me-2 md:grid-cols-5 gap-4 mb-10 items-start transition-transform duration-700 ease-in-out">
